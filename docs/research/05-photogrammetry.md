...
- **Идентификация** — 3D-распознавание лица
- **VR/AR** — создание аватаров

## Выводы

Фотограмметрия обеспечивает очень высокое качество 3D-реконструкции, но требует:
- Множества изображений (10–50)
- Контролируемых условий
- Значительных вычислительных ресурсов

Для практического применения 3D-реконструкции лица по 1–3 фотографиям со смартфона фотограмметрия не подходит как основной метод из-за высоких требований к входным данным. Однако она остаётся эталоном качества для сравнения с другими методами.
